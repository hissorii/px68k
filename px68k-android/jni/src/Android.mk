...
LOCAL_C_INCLUDES := /usr/local/android-ndk-r9/platforms/android-18/arch-arm/usr/include $(LOCAL_PATH)/$(SDL_PATH)/include /usr/local/android-ndk-r9/sources/android/support/include \
